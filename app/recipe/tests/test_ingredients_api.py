...
class PublicIngredientsAPI(TestCase):
    """Tests for the public ingredient API"""
...
class PrivateIngredientsAPI(TestCase):
    """Tests using an authorized user"""
    ...
    def test_ingredients_limited_to_user(self):
        """Test that the user can only see their ingredients"""
        payload = {
        ...
        i = Ingredient.objects.create(user=self.user, name='Tumeric')
